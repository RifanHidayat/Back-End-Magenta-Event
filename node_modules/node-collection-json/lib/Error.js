  ...
  _createClass(Error, null, [{
    ...
    value: function getByObject(json) {
      ...
      if (titleString === undefined) {
        throw new _CollectionError2.default('error.title String undefined');
      }

      //check the code
      var codeString = Error.getObjectValueByKey(json, "code");
      if (codeString === undefined) {
        throw new _CollectionError2.default('error.code String undefined');
      }

      //check the message
      var messageString = Error.getObjectValueByKey(json, "message");
      if (messageString === undefined) {
        throw new _CollectionError2.default('error.message String undefined');
      }
