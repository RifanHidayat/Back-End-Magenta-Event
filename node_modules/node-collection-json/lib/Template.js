...
var Template = function (_Entity) {
  ...
  _createClass(Template, [{
    ...
    value: function importItem(item) {
      ...
      try {
        for (var _iterator6 = this.getData()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var templateData = _step6.value;
          var _iteratorNormalCompletion7 = true;
          var _didIteratorError7 = false;
          var _iteratorError7 = undefined;

          try {
            for (var _iterator7 = item.getData()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              var itemData = _step7.value;
    ...
    value: function importJson(json) {
      ...
      try {
        for (var _iterator8 = this.getData()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
          var templateData = _step8.value;
